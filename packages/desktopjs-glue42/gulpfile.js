...
gulp.task('build:main', require('../../.gulp/tasks/build')(gulp, pkg, gulpConfig, 'desktopJS.Glue42', 'src/glue42.ts', '/iffe/desktopjs-glue42.js'));
...
gulp.task('dts', require('../../.gulp/tasks/dts')(gulp, pkg.name, gulpConfig.staging.dest + "/src/glue42.d.ts", "../../" + pkg.types));
